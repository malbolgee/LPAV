...
/* Faz um caminhamento dfs em graph a partir de SRC. */
void graph_dfs(graph_t *graph, int src);
...
DIST é um vetor de distâncias com cada membro tendo MWIDTH de largura.
...
atribuir a DIST, em uma posição qualquer, um valor de seu tipo e uma
que realiza operações aritméticas entre dois elementos de DIST ou 
